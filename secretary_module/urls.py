...
urlpatterns = [
    ...
    path('resident/<int:resident_id>/update/', views.resident_update, name='resident_update'),
    path('api/search-residents/', views.search_residents_api, name='search_residents_api'),
    path('api/dropdown-options/', views.get_dropdown_options, name='get_dropdown_options'),
    ...
    path("documentStampFee/", views.document_stamp_fee, name="document_stamp_fee"),
    path("documentStampFee/update/", views.document_stamp_fee_update, name="document_stamp_fee_update"),

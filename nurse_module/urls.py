...
urlpatterns = [
     ...
     path('nurseMaternalView/', views.maternalView, name='nurseMaternalView'),
     ...
     path('maternal/update-checkup-record/', views.update_checkup_record, name='updateCheckupRecord'),
